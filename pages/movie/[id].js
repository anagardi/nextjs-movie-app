...
export default function FullMovieDescription() {
    ...
    return (
        <Layout title="Discovering the Movie" subtitle="Behind the Reel: Unveiling Movie Magic">
            {isLoading && <Loader />}
            {!isLoading && <Box>
                ...
                <Box sx={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "40px", mb: "40px" }}>
                    ...
                    <Button variant="contained" sx={{ minWidth: '100px', backgroundColor: "secondary.main" }} onClick={handleOpen}>Delete</Button>
                    <Dialog open={open} onClose={handleClose} >
                        ...
                        <DialogActions>
                            <Link href="/">
                                <Button onClick={handleDelete} sx={{ minWidth: '100px', backgroundColor: "secondary.main" }} variant="contained">Delete</Button>
                            </Link>
                            <Button onClick={handleClose} sx={{ minWidth: '100px', backgroundColor: "primary.light" }} variant="contained" autoFocus>Cancel</Button>
                        </DialogActions>
                    </Dialog>
                </Box>
            </Box>}
